...
public class DoctorService {
    ...
    public static void loadDoctorsFromFile() {
        try {
            ...
            InputStream inputStream = new FileInputStream(new File("D:/SEF Project/CardiologistApplication/src/main/resources/datastorage/doctor.json"));
    ...
    public static void addDoctor(String username, String password) throws UsernameAlreadyExistsException, EmptyPasswordException, EmptyUsernameException {
        ...
        try {
            ObjectMapper mapper = new ObjectMapper();
            File file=new File("D:/SEF Project/CardiologistApplication/src/main/resources/datastorage/doctor.json");
